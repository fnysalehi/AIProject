...
public class Heuristics implements Comparator<Node> {
	...
	public int compare(Node x, Node y) {
		...
		long gestimate1 = (new Problem1()).pathCost(x.path), gestimate2 =  (new Problem1()).pathCost(y.path); //get path cost so far
		long hestimate1 = (new Problem1()).Heuristic(x.s),hestimate2 = (new Problem1()).Heuristic(y.s);
